      ...
      return html`
        ...
        <sl-drawer class="app-side-menu" placement="left">
          ...
          <nav class="app-side-menu-items">
            ...
            <a href="/newProduct" @click="${this.menuClick}">Add New Product</a>
            <a href="/blogPosts" @click="${this.menuClick}">View Blog Posts</a>
            <a href="/newBlogPost" @click="${this.menuClick}"
              >Add New Blog Post</a
            >
